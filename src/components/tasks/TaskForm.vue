        ...
        <div class="px-6 py-6 lg:px-8">
          <form @submit.prevent="submit">
            <div>
              ...
              <div class="mt-1 mb-1">
                <select
                  class="w-full p-1 mr-2 border-2 border-teal-500 hover:border-teal-700 rounded-[5px] appereance-none"
                  v-model="priority"
                >
...
const submit = () => {
  ...
  taskStore.add(taskName.value, priority.value);
